...
public sealed partial class RemoteDevicePicker : ContentDialog
{
    ...
    internal IEnumerable<RemoteSystem> ReturnDevices()
        => _listDevices.SelectedItems.Cast<RemoteSystem>();
    ...
    protected override void OnApplyTemplate()
    {
        ...
        if (_listDevices != null)
        {
            ...
            _listDevices.IsMultiSelectCheckBoxEnabled = SelectionMode == RemoteDeviceSelectionMode.Multiple;
    ...
    private void UpdateList()
    {
        ...
        if (RemoteSystems != null && _listDeviceTypes != null && _listDevices != null)
        {
            var bindinglist = _listDeviceTypes.SelectedValue.ToString().Equals("All")
                ? RemoteSystems
                : new ObservableCollection<RemoteSystem>([.. RemoteSystems.Where(a => a.Kind.Equals(_listDeviceTypes.SelectedValue.ToString(), StringComparison.OrdinalIgnoreCase))]);
